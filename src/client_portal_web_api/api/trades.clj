(ns client-portal-web-api.api.trades
...
(defn-spec iserver-account-trades-get-with-http-info any?
  ...
  []
  (call-api "/iserver/account/trades" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec iserver-account-trades-get (s/coll-of trade-spec)
  "List of Trades for the selected account
  Returns a list of trades for the currently selected account for current day and six previous days. It is advised to call this endpoint once per session."
  []
  (let [res (:data (iserver-account-trades-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode (s/coll-of trade-spec) res st/string-transformer)
       res)))

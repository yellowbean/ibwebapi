(ns client-portal-web-api.api.scanner
...
(defn-spec hmds-scanner-post scanner-result-spec
  "Run Scanner (Beta)
  Using a direct connection to the market data farm, will provide results to the requested scanner."
  [body inline-object-1]
  (let [res (:data (hmds-scanner-post-with-http-info body))]
    (if (:decode-models *api-context*)
       (st/decode scanner-result-spec res st/string-transformer)
       res)))


(defn-spec iserver-scanner-params-get-with-http-info any?
  "Scanner Parameters
  Returns an object contains four lists contain all parameters for scanners"
  []
  (call-api "/iserver/scanner/params" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec iserver-scanner-params-get inline-response-200-32-spec
  "Scanner Parameters
  Returns an object contains four lists contain all parameters for scanners"
  []
  (let [res (:data (iserver-scanner-params-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode inline-response-200-32-spec res st/string-transformer)
       res)))


(defn-spec iserver-scanner-run-post-with-http-info any?
  "run scanner to get a list of contracts"
  [body scanner-params]
  (check-required-params body)
  (call-api "/iserver/scanner/run" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec iserver-scanner-run-post (s/coll-of inline-response-200-33-spec)
  "run scanner to get a list of contracts"
  [body scanner-params]
  (let [res (:data (iserver-scanner-run-post-with-http-info body))]
    (if (:decode-models *api-context*)

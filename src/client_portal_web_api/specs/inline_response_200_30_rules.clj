(ns client-portal-web-api.specs.inline-response-200-30-rules
...
(def inline-response-200-30-rules-data
  {
...
(def inline-response-200-30-rules-spec
  (ds/spec
    {:name ::inline-response-200-30-rules
     :spec inline-response-200-30-rules-data}))
